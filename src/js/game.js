import { WORD, KEYBOARD_LETTERS } from "./consts";
...
const createPlaceholderHTML = () => {
  ...
  const placeholderArray = Array.from(word);

  let placeholderHTML = placeholderArray.reduce(
...
const stopGame = (status) => {
  ...
  document.getElementById('game').innerHTML += `<p>The word was: <span class="result-word">${word}</span></p><button id="play-again"
